...
<body>
    ...
    <nav class="navbar navbar-expand-lg border-bottom navbar-themed" id="main-nav-bar">
        ...
        <div id="mySidebar" class="sidebar">
            ...
            <a href="#">Nombres Más comunes</a>
            <a href="#">Nombres Menos comunes</a>
            <a href="#">Cantidad de Electores</a>
            <a href="#">Reporte Consolidados</a>
            <a href="#">Bitácora de Consultas</a>
        </div>
  ...
  ">
    ...
    <div>
        <table class="table table-hover table-striped " style="font-family: Arial, Helvetica, sans-serif; font-size:4ch; width: 45%; margin-left: 700px; margin-right: 700px; margin-top:3%; ">

            <thead>
                <tr>
                    <th style="padding-left:4%;">Nombre</th>
                    <th style="padding-left:4%;">P. Apellido</th>
                    <th style="padding-left:4%;">S. Apellido</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="table-secondary" style="padding-left:4%;"> <input> </td>
                    <td class="table-secondary" style="padding-left:4%;"> <input> </td>
                    <td class="table-secondary" style="padding-left:4%;"> <input> </td>
                    <td style="padding-left:2.5%;"><button type="button" class="btn btn-outline-success">Buscar</button> </td>
        ...
        <div>
            ...
            <table class="table table-hover table-striped " style="font-family: Arial, Helvetica, sans-serif; font-size:4ch; width: 60%;margin-left: 500px; margin-right: 500px; margin-top:4% ;">
    ...
    <div class="container-fluid mt-5" style="font-family: Arial, Helvetica, sans-serif; font-size:5ch;  margin-left: 48% ;">

        <div class="card mx-2" style="margin-top:12%;width: 600px; position: absolute; ">
            <div class="row mb-2 ">
